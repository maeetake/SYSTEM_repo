...
from PACKAGE.d_build_lstm_and_transformer_models_prompt import build_lstm, build_transformer
import sys
import os
import logging
import numpy as np
...
def main():
    ...
    try:
        ...
        # Build LSTM Model
        lstm_model = build_lstm(input_shape=input_shape)

        # Build Transformer Model
        transformer_model = build_transformer(input_shape=input_shape)
