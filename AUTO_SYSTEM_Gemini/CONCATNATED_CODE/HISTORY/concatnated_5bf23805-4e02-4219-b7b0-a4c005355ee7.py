...
def main():
    ...
    try:
        ...
        # Generate enough data to avoid issues with small sequence/split sizes
        mock_data = {
            'Date': pd.to_datetime([f'2020-01-{i:02d}' for i in range(1, 31)] * 10),
            'Open': np.linspace(150, 250, 300),
            'High': np.linspace(152, 255, 300),
            'Low': np.linspace(148, 248, 300),
            'Close': np.linspace(151, 252, 300),
        }
